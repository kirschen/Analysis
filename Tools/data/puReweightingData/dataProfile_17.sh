...
pileupCalc.py -i $JSON --inputLumiJSON $PILEUP_LATEST --calcMode true --minBiasXsec 65740 --maxPileupBin 100 --numPileupBins 100 PU_2017_${LUMI}_XSecDown.root
...
pileupCalc.py -i $JSON --inputLumiJSON $PILEUP_LATEST --calcMode true --minBiasXsec 72660 --maxPileupBin 100 --numPileupBins 100 PU_2017_${LUMI}_XSecUp.root
